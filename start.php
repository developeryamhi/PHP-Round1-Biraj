...
event()->on('gateway.created.paypal', function (PaypalGateway $paypal) {
...
event()->on('gateway.created.braintree', function (BrainTreeGateway $brainTree) {
...
event()->on('gateway.transaction.start', function (PaymentGateway $gateway) {
...
event()->on('gateway.transaction.end', function (PaymentGateway $gateway) {
